...
```text
请帮我安装 `cdopt-optimization` skill，链接是：https://github.com/VeryMath/AI4Math-Optimization.git，分支：feature/cdopt-skill。请读取 `.agent.md`，安装其中声明的 Skill entrypoint，验证 `$cdopt-optimization` 可用，并告诉我是否需要重启 agent。
```
