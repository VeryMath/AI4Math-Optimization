...
class CdoptSkillShapeTests(unittest.TestCase):
    def test_public_docs_use_portable_smoke_test_paths(self):
        files = [
            ROOT / "skills" / "cdopt-optimization" / "README.md",
            ROOT / "skills" / "cdopt-optimization" / "README.zh-CN.md",
            ROOT / "skills" / "cdopt-optimization" / "SKILL.md",
            ROOT / "skills" / "cdopt-optimization" / "references" / "INDEX.md",
        ]
    ...
    def test_license_and_acknowledgment_are_visible(self):
        readme = (ROOT / "skills" / "cdopt-optimization" / "README.md").read_text(encoding="utf-8")
